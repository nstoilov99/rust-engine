...
| Tag | Description |
|-----|-------------|
| `#project/rust-engine` | rust-engine |
...
| `#agent/hermes` | hermes agent plugin |
| `#agent/letta` | letta agent plugin |
...
```
Fix login button tooltip #project/rust-engine #agent/amp #type/fix #priority/high

Add analytics dashboard #project/rust-engine #agent/ccr #type/feature
```

---

#project/rust-engine
#agent/amp #agent/ccr #agent/claude-code #agent/codex #agent/cursor-cli #agent/droid #agent/gemini #agent/github-copilot #agent/hermes #agent/letta #agent/opencode #agent/qwen-code
