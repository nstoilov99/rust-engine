...
fn get_type_icon(asset_type: AssetType) -> &'static str {
    match asset_type {
        ...
        AssetType::InputAction => "\u{1F3AE}",  // 🎮
        AssetType::InputMappingContext => "\u{1F5FA}",  // 🗺
...
fn get_type_icon_small(asset_type: AssetType) -> &'static str {
    match asset_type {
        ...
        AssetType::Shader => "Sh",
        AssetType::Prefab => "P",
        AssetType::InputAction => "IA",
        AssetType::InputMappingContext => "IC",
        AssetType::Unknown => "?",
    }
}
...
fn get_type_color(asset_type: AssetType) -> Color32 {
    match asset_type {
        ...
        AssetType::InputAction => Color32::from_rgb(120, 200, 160),      // Teal
        AssetType::InputMappingContext => Color32::from_rgb(160, 140, 200), // Lavender
...
fn get_asset_browser_icon(asset_type: AssetType) -> Option<AssetBrowserIcon> {
    match asset_type {
        ...
        AssetType::InputAction => Some(AssetBrowserIcon::FileDocument),
        AssetType::InputMappingContext => Some(AssetBrowserIcon::FileDocument),
