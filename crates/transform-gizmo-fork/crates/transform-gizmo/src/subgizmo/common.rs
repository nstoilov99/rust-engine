...
pub(crate) fn draw_circle(
    ...
    let rotation = {
        ...
        DQuat::from_mat3(&DMat3::from_cols(-forward, right, up))
    };
...
// Z-up fork: Plane tangent/bitangent adjusted for Z-up coordinate system
// In Z-up: X=forward, Y=right, Z=up
pub(crate) const fn plane_bitangent(direction: GizmoDirection) -> DVec3 {
    match direction {
        GizmoDirection::X => DVec3::Y,  // YZ plane: bitangent = Y
        GizmoDirection::Y => DVec3::X,  // XZ plane: bitangent = X
        GizmoDirection::Z => DVec3::X,  // XY plane: bitangent = X
...
pub(crate) const fn plane_tangent(direction: GizmoDirection) -> DVec3 {
    match direction {
        GizmoDirection::X => DVec3::Z,  // YZ plane: tangent = Z
        GizmoDirection::Y => DVec3::Z,  // XZ plane: tangent = Z
        GizmoDirection::Z => DVec3::Y,  // XY plane: tangent = Y
        GizmoDirection::View => DVec3::ZERO, // Unused
    }
}
