...
pub struct ConfigIdUnique<'ctx> {
    imp: __sdk::UniqueConstraintHandle<Config, u32>,
...
#[allow(non_camel_case_types)]
/// Extension trait for query builder access to the table `Config`.
///
/// Implemented for [`__sdk::QueryTableAccessor`].
pub trait configQueryTableAccess {
    #[allow(non_snake_case)]
    /// Get a query builder for the table `Config`.
    fn config(&self) -> __sdk::__query_builder::Table<Config>;
}

impl configQueryTableAccess for __sdk::QueryTableAccessor {
    fn config(&self) -> __sdk::__query_builder::Table<Config> {
        __sdk::__query_builder::Table::new("config")
    }
}
