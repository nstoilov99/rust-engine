...
pub struct PlayerCols {
    ...
    pub hp_max: __sdk::__query_builder::Col<Player, f32>,
    pub mana: __sdk::__query_builder::Col<Player, f32>,
    pub mana_max: __sdk::__query_builder::Col<Player, f32>,
...
impl __sdk::__query_builder::HasCols for Player {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        PlayerCols {
            ...
            mana_max: __sdk::__query_builder::Col::new(table_name, "mana_max"),
