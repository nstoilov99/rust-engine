...
- Next: Refactor Checkpoint #6 (Rendering API Cleanup — slim, see `docs/roadmap/ROADMAP.md`), then Task 39.8 (Plugin System & Module Registry — implements against Task 40's registry contract)
