...
- Task 41.5 (Animation at Scale + IK): **complete — pending live verification and baseline capture** — palette SSBO ring + instanced skinned draws, two-phase FK with retained model space, rayon pose evaluation, update-rate throttling, two-bone/look-at IK with graph-declared chains + foot placement; P8 (clip layout) gated on baseline profiling, not yet exercised. See `docs/roadmap/VULKANO-41.5-ANIMATION-SCALE.md`, `docs/ARCHITECTURE.md` ▸ Animation at Scale
